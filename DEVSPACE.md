...
Tracked in `docs/project/todo.md` (devspace items) — notably the selector's edit mode via `ds add --edit`, the unarchive dangling-checkout guard, persistent checkout presentation, and ordinary-project devspace detection.
